...
const hardcodedQuestions: Question[] = [
  ...
  },
  {
    ...
    modelAnswer:
      "<b>[첫 취업 준비생이라면?]</b><br> 팀 프로젝트에서 일정이 자꾸 밀려 팀 분위기가 가라앉은 상황이 있었습니다.<br> 제가 먼저 팀원들과 일정을 다시 정리하고 우선순위를 조정해 '작동하는 기능부터 완성하자'는 MVP 전략을 제안했습니다.<br> 이후 팀원 간 협업이 원활해졌고 프로젝트도 제시간에 마무리할 수 있었습니다.<br><br><b>[현직 개발자로, 이직 면접이라면?]</b><br> 신규 기능 런칭 프로젝트에서 PO가 중간 이탈해 일정이 크게 흔들린 적이 있습니다.<br> PM 부재 상태에서 주도적으로 요구사항을 정리하고 우선순위를 재설정했으며, 팀원들의 강점에 맞게 태스크를 재분배했습니다.<br> 또한 매일 15분 스탠드업 미팅을 도입해 진행 상황을 공유하고 장애물을 빠르게 해결했습니다.<br> 결과적으로 기존 일정보다 단 3일 지연으로 프로젝트를 완료
