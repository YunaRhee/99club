      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {questions.map((question) => (
            <Card key={question.id} className="bg-hanghae-gray border-[#3a3e41] border-[1px]">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-lg">
                  <Link href={`/questions/${question.id}`} className="hover:text-main-red transition-colors">
                    {question.title}
                  </Link>
                </CardTitle>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Link
                    ...
                    className="text-main-red hover:text-main-red/80 text-sm font-medium"
                  >
                    자세히 보기 →
                  </Link>
                </div>
