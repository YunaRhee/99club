...
export default function Home() {
  ...
  const [questions, setQuestions] = useState<{
    ...
    const day5ReleaseTime = new Date(2025, 3, 15, 9, 0, 0) // 2025년 4월 15일 오전 
    ...
    if (now >= day6ReleaseTime) {
      // Day 5 질문 표시
      return {
        frontend: hardcodedQuestions.q22, // Day 5 Frontend 질문
        backend: hardcodedQuestions.q23, // Day 5 Backend 질문
        common: hardcodedQuestions.q21, // Day 5 공통 질문
